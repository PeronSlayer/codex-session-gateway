...
**Status: Implemented** for scaffold guidance. Runtime troubleshooting is **Planned**.
...
| Frozen install reports a missing lockfile | Complete the documented one-time bootstrap; do not bypass frozen installation in CI |
...
Do not attach tokens, credential stores, full transcripts or raw environment dumps
to reports. See [SUPPORT](../SUPPORT.md), [SECURITY](../SECURITY.md) and
